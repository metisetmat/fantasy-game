...
export function buildFullMatchRouteEconomyRecheckAfterSelectivityFixModel(): FullMatchRouteEconomyRecheckAfterSelectivityFixModel {
  ...
  const modelBase = {
    ...
    mediumQualityDangerToOpportunityRateAfter: percent(routeEconomyAudit.mediumQualityDangerConvertedToOpportunityCount, mediumQualityCount),
    lowQualityDangerToOpportunityRateBefore: 100,
    lowQualityDangerToOpportunityRateAfter: percent(routeEconomyAudit.lowQualityDangerConvertedToOpportunityCount, lowQualityCount),
...
export function renderFullMatchRouteEconomyRecheckAfterSelectivityFix6QValidation(
  ...
  const checks = [
    ...
    checkLine("high-quality danger opportunity rate uses matching quality numerator", model.highQualityDangerToOpportunityRateAfter <= 100, `${model.highQualityDangerToOpportunityRateAfter}%`),
    checkLine("medium-quality danger opportunity rate uses matching quality numerator", model.mediumQualityDangerToOpportunityRateAfter <= 100, `${model.mediumQualityDangerToOpportunityRateAfter}%`),
    checkLine("low-quality danger opportunity rate uses matching quality numerator", model.lowQualityDangerToOpportunityRateAfter <= 100, `${model.lowQualityDangerToOpportunityRateAfter}%`),
