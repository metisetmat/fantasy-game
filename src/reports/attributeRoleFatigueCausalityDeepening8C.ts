...
export function renderAttributeRoleFatigueCausalityDeepening8CValidation(
  ...
  const checks = [
    ...
    checkLine("official causality links are event-backed", model.causalityAudit.causalityWithoutOfficialEventCount === 0, String(model.causalityAudit.causalityWithoutOfficialEventCount)),
