...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 6C - Calibration Carryover & Full-Match Regression Reconciliation",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "validation.share-pack.md": "proves the 6C share pack is current, complete, and below 20 files",
    "fullmatch-calibration-carryover-reconciliation-6c.md": "diagnoses which validated batch/live calibrations are not yet carried into the official full-match scoring path",
    "validation.fullmatch-calibration-carryover-reconciliation-6c.md": "validates the 6C carryover matrix, scoring path audit, warning surface, and no-mutation guardrails",
    "README.md": "compact reviewer orientation for the 6C share pack",
    "manifest.md": "compatibility manifest listing the 6C share pack files",
