...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 8M - Manual Post-Match Observation Review Form",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "coach-report.product.html": "clean product-facing coach report with score source, action plan, tactical map cards, prudent trend signals, 8K observation-only decision layer, Sprint 8L seasonless loop, and Sprint 8M manual review form",
    "coach-report.export.html": "Sprint 8M compact story-first export snapshot with restored action plan, cleaned replay wording, next-match observation layer, 8L tracking grid, and blank manual post-match review form under strict read-time budget",
    ...
    "validation.share-pack.md": "proves the 8M share pack is current, complete, minimal, and below 20 files",
    "coach-report-manual-post-match-observation-review-form-8m.md": "documents the manual post-match observation review form, blank fields, manual outcome options, persistence boundary, export budget, and source-of-truth preservation",
    "validation.coach-report-manual-post-match-observation-review-form-8m.md": "proves the 8M form has three linked blank sections, four unchecked manual options per section, no automatic outcome, no persistence, no future evidence claim, and preserved 8L/8K/8I baselines",
    "README.md": "compact reviewer orientation for the 8M share pack",
    "manifest.md": "compatibility manifest listing the 8M share pack files",
