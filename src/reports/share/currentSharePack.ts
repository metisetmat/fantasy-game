...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 7G - Coach Report Multi-Match Comparison & Trend Signals",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "coach-report.product.html": "clean product-facing coach report with score source, action plan, tactical map cards, prudent multi-match trend signals, profiles to observe, next-match signals, and collapsed appendices",
    "coach-report.export.html": "print-ready export snapshot derived from coach-report.product.html with prudent trend signals and no second source of truth",
    ...
    "validation.share-pack.md": "proves the 7G share pack is current, complete, and below 20 files",
    "coach-report-multi-match-comparison-trend-signals-7g.md": "validates prudent multi-match trend signals, baseline metadata repair, placeholder cleanup, and source-of-truth separation after 7F",
    "validation.coach-report-multi-match-comparison-trend-signals-7g.md": "proves the 7G model is PASS with trend signals visible, no placeholders, no unexplained FAIL, preserved tactical maps, and unchanged scoring guardrails",
    "README.md": "compact reviewer orientation for the 7G share pack",
    "manifest.md": "compatibility manifest listing the 7G share pack files",
