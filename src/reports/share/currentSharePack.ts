...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 6R - Earned Danger Outcome Distribution",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "validation.share-pack.md": "proves the 6R share pack is current, complete, and below 20 files",
    "fullmatch-earned-danger-outcome-distribution-6r.md": "validates earned-danger outcome distribution, longitudinal route economy, half-chance layers, and score_change guardrails after 6Q",
    "validation.fullmatch-earned-danger-outcome-distribution-6r.md": "validates 6R earned danger outcome metrics, volume preservation, longitudinal stability, and no-rewrite guardrails",
    "README.md": "compact reviewer orientation for the 6R share pack",
    "manifest.md": "compatibility manifest listing the 6R share pack files",
