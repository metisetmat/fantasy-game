...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 4L - Selection Preview Clarity & Coach-Ready Copy",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "coach-report.experimental.html": "experimental full-match harness coach HTML sample with coach-ready Selection Preview cards, official aggregate support labels, non-applied guardrails, clean UTF-8 coach copy, and unchanged source separation",
    ...
    "validation.share-pack.md": "proves the 4L share pack is current, complete, and below 20 files",
    "fullmatch-workbench-chain-replay-4l.md": "summarizes Selection Preview coach-ready copy, source separation, non-applied guardrails, and unchanged scoring",
    "validation.fullmatch-workbench-chain-replay-4l.md": "validates Selection Preview coach copy, visible wording, source separation, and unchanged scoring guardrails",
    "README.md": "compact reviewer orientation for the 4L share pack",
    "manifest.md": "compatibility manifest listing the 4L share pack files",
