...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 4G - Profile Signal Calibration & Encoding Fix",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "validation.share-pack.md": "proves the 4G share pack is current, complete, and below 20 files",
    "fullmatch-workbench-chain-replay-4g.md": "summarizes profile signal calibration, encoding status, and guardrails",
    "validation.fullmatch-workbench-chain-replay-4g.md": "validates profile signals, encoding coverage, source separation, and unchanged scoring guardrails",
    "fullmatch-trace-validation-4g.md": "detailed profile-by-profile trace validation and profile signal report",
    "README.md": "compact reviewer orientation for the 4G share pack",
    "manifest.md": "compatibility manifest listing the 4G share pack files",
