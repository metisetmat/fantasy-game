...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 3J - Real Isolated Replay Engine",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  excludedByDefault: [],
  fileReasons: {
    "package.json": "records npm scripts and real isolated replay engine contract test wiring",
    ...
    "coach-report.default.html": "default full-match harness coach HTML sample without real isolated replay tags",
    "coach-report.experimental.html": "experimental full-match harness coach HTML sample with real isolated replay diagnostics",
    ...
    "validation.share-pack.md": "proves the 3J share pack is current, complete, and below 20 files",
    "fullmatch-workbench-chain-replay-3j.md": "documents real isolated segment replay events behind the opt-in flag without official timeline, normal live selection, or scoring mutation",
    "validation.fullmatch-workbench-chain-replay-3j.md": "validates real isolated replay status, event generation, baseline/override divergence proof, rejected candidates, score guardrails, production guardrails, and source-of-truth invariants",
    "README.md": "compact reviewer orientation for the 3J share pack",
    "manifest.md": "compatibility manifest listing the 3J share pack files",
