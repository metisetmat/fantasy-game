...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 4M - Selection Preview Profile View",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "coach-report.experimental.html": "experimental full-match harness coach HTML sample with concrete Selection Preview profile cards, localized role families and attributes, official aggregate support sections, non-applied guardrails, clean UTF-8 coach copy, and unchanged source separation",
    ...
    "validation.share-pack.md": "proves the 4M share pack is current, complete, and below 20 files",
    "fullmatch-workbench-chain-replay-4m.md": "summarizes Selection Preview Profile View cards, source separation, non-applied guardrails, and unchanged scoring",
    "validation.fullmatch-workbench-chain-replay-4m.md": "validates Selection Preview Profile View content, visible wording, source separation, and unchanged scoring guardrails",
    "README.md": "compact reviewer orientation for the 4M share pack",
    "manifest.md": "compatibility manifest listing the 4M share pack files",
