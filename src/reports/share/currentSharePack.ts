...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 6F - Official Route Family Mix Activation / Non-Shot Route Availability",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "validation.share-pack.md": "proves the 6F share pack is current, complete, and below 20 files",
    "fullmatch-route-family-mix-activation-6f.md": "proves official non-shot route family availability, selection, scoring, and batch mix across 50 full matches",
    "validation.fullmatch-route-family-mix-activation-6f.md": "validates the 6F route family mix activation, guardrails, team opportunity balance, and PASS/PARTIAL/FAIL justification",
    "README.md": "compact reviewer orientation for the 6F share pack",
    "manifest.md": "compatibility manifest listing the 6F share pack files",
