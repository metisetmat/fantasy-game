...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 4B - Coach Test Plan to Selection Preview",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "coach-report.experimental.html": "experimental full-match harness coach HTML sample with clean UTF-8 coach copy, collapsed technical details, timeline review, sandbox decision panel, evidence calibration, multi-scenario confidence block, coach test plan, and selection preview",
    ...
    "validation.share-pack.md": "proves the 4B share pack is current, complete, and below 20 files",
    "fullmatch-workbench-chain-replay-4b.md": "documents the selection preview derived from the coach test plan, linked scenarios, role profiles, and guardrails",
    "validation.fullmatch-workbench-chain-replay-4b.md": "validates selection preview rendering, source-of-truth boundaries, and unchanged sandbox/scoring guardrails",
    "README.md": "compact reviewer orientation for the 4B share pack",
    "manifest.md": "compatibility manifest listing the 4B share pack files",
