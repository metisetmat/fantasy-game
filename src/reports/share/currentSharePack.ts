...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 8I - Story-First Export Budget & Validation Threshold Fix",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "coach-report.export.html": "Sprint 8I compressed story-first export snapshot under strict numeric read-time budget with no full timeline, batch diagnostics, or sandbox panel",
    ...
    "validation.share-pack.md": "proves the 8I share pack is current, complete, minimal, and below 20 files",
    "story-first-export-budget-validation-threshold-fix-8i.md": "documents the strict export budget threshold fix, compressed export sections, product preservation, and source-of-truth regression guardrails",
    "validation.story-first-export-budget-validation-threshold-fix-8i.md": "proves exportUnder900Seconds/exportUnder800Seconds come from actual numeric read-time thresholds and cannot PASS when violated",
    "README.md": "compact reviewer orientation for the 8I share pack",
    "manifest.md": "compatibility manifest listing the 8I share pack files",
