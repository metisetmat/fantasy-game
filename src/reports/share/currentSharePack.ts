...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 8K - Coach Report Decision Layer & Next-Match Observation Plan",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "coach-report.product.html": "clean product-facing coach report with score source, action plan, tactical map cards, prudent trend signals, and Sprint 8K observation-only decision layer",
    "coach-report.export.html": "Sprint 8K compact story-first export snapshot with restored action plan, cleaned replay wording, and next-match observation layer under strict read-time budget",
    ...
    "validation.share-pack.md": "proves the 8K share pack is current, complete, minimal, and below 20 files",
    "coach-report-decision-layer-next-match-observation-plan-8k.md": "documents the observation-only decision layer, confirmation/disconfirmation matrix, wording cleanup, export budget, and source-of-truth preservation",
    "validation.coach-report-decision-layer-next-match-observation-plan-8k.md": "proves the decision layer has three cards, three next-match observation items, no selection/tactic imposition, clean replay wording, and honest export thresholds",
    "README.md": "compact reviewer orientation for the 8K share pack",
    "manifest.md": "compatibility manifest listing the 8K share pack files",
