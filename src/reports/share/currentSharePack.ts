...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 4V - Phase Visuals & Tactical Pitch Panels",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "validation.share-pack.md": "proves the 4V share pack is current, complete, and below 20 files",
    "fullmatch-workbench-chain-replay-4v.md": "summarizes the phase-visual rollout, tactical pitch panel availability, source-of-truth preservation, and unchanged scoring guardrails",
    "validation.fullmatch-workbench-chain-replay-4v.md": "validates phase panel generation, source-of-truth preservation, visible copy guardrails, print CSS/page-break protection, non-selection scope, and unchanged scoring guardrails",
    "README.md": "compact reviewer orientation for the 4V share pack",
    "manifest.md": "compatibility manifest listing the 4V share pack files",
