...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 8O - Manual Review Preview Renderer Without Persistence",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "coach-report.product.html": "clean product-facing coach report with score source, action plan, tactical map cards, prudent trend signals, 8K observation-only decision layer, Sprint 8L seasonless loop, Sprint 8M manual review form, Sprint 8N manual intake boundary, and Sprint 8O non-persistent preview renderer",
    "coach-report.export.html": "Sprint 8O compact story-first export snapshot with restored action plan, cleaned replay wording, next-match observation layer, 8L tracking grid, blank 8M manual form, 8N manual intake boundary, and non-persistent manual review preview metadata",
    ...
    "validation.share-pack.md": "proves the 8O share pack is current, complete, minimal, and below 20 files",
    "coach-report-manual-review-preview-renderer-without-persistence-8o.md": "documents the non-persistent preview renderer, valid-before-render proof, three preview cards, non-persistence boundary, official-truth boundary, source-of-truth preservation, export budget, and wording audit",
    "validation.coach-report-manual-review-preview-renderer-without-persistence-8o.md": "proves the 8O preview renders only a valid 8N payload, blocks invalid payloads, preserves 8N/8M/8L/8K, and creates no persistence, official truth, mutation, memory, selection, or tactical instruction",
    "README.md": "compact reviewer orientation for the 8O share pack",
    "manifest.md": "compatibility manifest listing the 8O share pack files",
