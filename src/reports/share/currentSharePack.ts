...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 5E - Database Adapter Implementation Spike Without Product Activation",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "validation.share-pack.md": "proves the 5E share pack is current, complete, and below 20 files",
    "fullmatch-workbench-chain-replay-5e.md": "summarizes experimental database adapter spike implementation, disabled feature flag, dry-run semantics, and no-product-activation guardrails",
    "validation.fullmatch-workbench-chain-replay-5e.md": "validates the experimental database adapter spike, export HTML section, evidence category, and unchanged scoring guardrails",
    "README.md": "compact reviewer orientation for the 5E share pack",
    "manifest.md": "compatibility manifest listing the 5E share pack files",
