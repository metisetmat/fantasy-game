...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 3I - Controlled Segment Replay Comparison",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  excludedByDefault: [],
  fileReasons: {
    "package.json": "records npm scripts and controlled segment replay comparison contract test wiring",
    ...
    "coach-report.default.html": "default full-match harness coach HTML sample without controlled segment replay comparison tags",
    "coach-report.experimental.html": "experimental full-match harness coach HTML sample with controlled segment replay comparison diagnostics",
    ...
    "validation.share-pack.md": "proves the 3I share pack is current, complete, and below 20 files",
    "fullmatch-workbench-chain-replay-3i.md": "documents controlled segment replay comparison behind the opt-in flag without normal live selection or scoring mutation",
    "validation.fullmatch-workbench-chain-replay-3i.md": "validates controlled replay comparison status, baseline/override divergence proof, rejected candidates, score guardrails, production guardrails, and source-of-truth invariants",
    "README.md": "compact reviewer orientation for the 3I share pack",
    "manifest.md": "compatibility manifest listing the 3I share pack files",
