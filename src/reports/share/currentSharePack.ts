...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 8B - Match Story Chronology, Cumulative Score & Narrative Quality Fix",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "validation.share-pack.md": "proves the 8B share pack is current, complete, minimal, and below 20 files",
    "match-story-chronology-cumulative-score-narrative-quality-fix-8b.md": "documents the corrected official story chronology, cumulative segment scores, turning-point order, narrative quality, and source-of-truth regression audits",
    "validation.match-story-chronology-cumulative-score-narrative-quality-fix-8b.md": "proves the 8B story fix is PASS, preserves 8A/7H/6X guardrails, and keeps product/export story integration clean",
    "README.md": "compact reviewer orientation for the 8B share pack",
    "manifest.md": "compatibility manifest listing the 8B share pack files",
