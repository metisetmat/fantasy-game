...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 8L - Coach Report Seasonless Learning Loop & Observation Outcome Tracker",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "coach-report.product.html": "clean product-facing coach report with score source, action plan, tactical map cards, prudent trend signals, 8K observation-only decision layer, and Sprint 8L seasonless learning loop",
    "coach-report.export.html": "Sprint 8L compact story-first export snapshot with restored action plan, cleaned replay wording, next-match observation layer, and manual post-match tracking grid under strict read-time budget",
    ...
    "validation.share-pack.md": "proves the 8L share pack is current, complete, minimal, and below 20 files",
    "coach-report-seasonless-learning-loop-observation-outcome-tracker-8l.md": "documents the seasonless learning loop, pending observation outcome tracker, manual post-match options, future-claim guard, export budget, and source-of-truth preservation",
    "validation.coach-report-seasonless-learning-loop-observation-outcome-tracker-8l.md": "proves the 8L tracker has three pending cards, confirmation/disconfirmation/insufficient-evidence criteria, no season memory, no persistence, no automatic decision, and no future-result claim",
    "README.md": "compact reviewer orientation for the 8L share pack",
    "manifest.md": "compatibility manifest listing the 8L share pack files",
