...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 4H - Coach Report V1 Visualization",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "coach-report.experimental.html": "experimental full-match harness coach HTML sample with Coach Report V1 visualization, clean UTF-8 coach copy, collapsed technical details, timeline review, sandbox decision panel, evidence calibration, multi-scenario confidence block, coach test plan, selection preview, match event trace spine diagnostic, match trace aggregate diagnostic, and Coach Report V0 from official trace aggregates",
    ...
    "validation.share-pack.md": "proves the 4H share pack is current, complete, and below 20 files",
    "fullmatch-workbench-chain-replay-4h.md": "summarizes Coach Report V1 visualization, official source scope, empty states, and guardrails",
    "validation.fullmatch-workbench-chain-replay-4h.md": "validates V1 visualization, source separation, encoding coverage, and unchanged scoring guardrails",
    "README.md": "compact reviewer orientation for the 4H share pack",
    "manifest.md": "compatibility manifest listing the 4H share pack files",
