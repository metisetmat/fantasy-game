...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 6O - Earned Danger Reintroduction & Gate Tuning",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "validation.share-pack.md": "proves the 6O share pack is current, complete, and below 20 files",
    "fullmatch-earned-danger-gate-tuning-6o.md": "compares the 6N gate baseline with 6O selective earned/borderline danger reintroduction, without score rewrites",
    "validation.fullmatch-earned-danger-gate-tuning-6o.md": "validates the 6O gate tuning audit, 6N baseline comparison, route diversity, density preservation, and no forced-score guardrails",
    "README.md": "compact reviewer orientation for the 6O share pack",
    "manifest.md": "compatibility manifest listing the 6O share pack files",
