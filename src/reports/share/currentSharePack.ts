...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 3C - Experimental Chain Context to Shadow Route Selection",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "validation.share-pack.md": "proves the 3C share pack is current, complete, and below 20 files",
    "fullmatch-workbench-chain-replay-3c.md": "documents experimental chain context to shadow route selection behind the opt-in flag",
    "validation.fullmatch-workbench-chain-replay-3c.md": "validates shadow route selection, production proxy comparison, blocked closed/unavailable routes, no score mutation, and source-of-truth invariants",
    "README.md": "compact reviewer orientation for the 3C share pack",
    "manifest.md": "compatibility manifest listing the 3C share pack files",
    ...
    "bundle__simulation.md": "bundles visual multi-action WorkbenchChain fixtures/replay/tests, experimental full-match chain consumption, segment context influence, diagnostic route candidate influence, shadow route selection, route selection flag, mini-match spatial route selection, replay seed, grounding diagnostics, and tests",
