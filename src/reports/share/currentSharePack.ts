...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 4J - Coach Report V1 Legacy Cleanup & Score Coherence",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "coach-report.experimental.html": "experimental full-match harness coach HTML sample with Coach Report V1 legacy cleanup, explicit score source labels, official V1 reading first, grouped experimental hypotheses, collapsed technical traceability, clean UTF-8 coach copy, and unchanged source separation",
    ...
    "validation.share-pack.md": "proves the 4J share pack is current, complete, and below 20 files",
    "fullmatch-workbench-chain-replay-4j.md": "summarizes Coach Report V1 legacy cleanup, score source clarity, French copy cleanup, source separation, and guardrails",
    "validation.fullmatch-workbench-chain-replay-4j.md": "validates legacy cleanup, score source clarity, French copy quality, source separation, encoding coverage, and unchanged scoring guardrails",
    "README.md": "compact reviewer orientation for the 4J share pack",
    "manifest.md": "compatibility manifest listing the 4J share pack files",
