...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 3K - Controlled Route Resolution Sandbox",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  excludedByDefault: [],
  fileReasons: {
    "package.json": "records npm scripts and controlled route resolution sandbox contract test wiring",
    ...
    "coach-report.experimental.html": "experimental full-match harness coach HTML sample with controlled route resolution sandbox diagnostics",
    ...
    "validation.share-pack.md": "proves the 3K share pack is current, complete, and below 20 files",
    "fullmatch-workbench-chain-replay-3k.md": "documents controlled route resolution sandbox outputs behind the opt-in flag without official timeline, normal live selection, or scoring mutation",
    "validation.fullmatch-workbench-chain-replay-3k.md": "validates sandbox status, route outcomes, baseline/override divergence proof, rejected candidates, score guardrails, production guardrails, and source-of-truth invariants",
    "README.md": "compact reviewer orientation for the 3K share pack",
    "manifest.md": "compatibility manifest listing the 3K share pack files",
