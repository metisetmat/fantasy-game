...
export const currentSprint: CurrentSharePackConfig = {
  name: "Sprint 4W - Phase Visual Readability & Legend Calibration",
  mode: "MINIMAL_REVIEW",
  requiredFiles: [
    "package.json",
    "tsconfig.json",
  ...
  fileReasons: {
    ...
    "validation.share-pack.md": "proves the 4W share pack is current, complete, and below 20 files",
    "fullmatch-workbench-chain-replay-4w.md": "summarizes the phase-visual readability rollout, visible legend, zone hierarchy, source-of-truth preservation, and unchanged scoring guardrails",
    "validation.fullmatch-workbench-chain-replay-4w.md": "validates phase visual readability, legend visibility, zone emphasis, visible copy guardrails, print CSS/page-break protection, non-selection scope, and unchanged scoring guardrails",
    "README.md": "compact reviewer orientation for the 4W share pack",
    "manifest.md": "compatibility manifest listing the 4W share pack files",
