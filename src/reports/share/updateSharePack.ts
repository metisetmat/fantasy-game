...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 2Z - Experimental FullMatch Chain Consumption Behind Flag";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    target: "fullmatch-workbench-chain-replay-2z.md",
    reason: "Sprint 2Z experimental full-match chain consumption report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "validation.fullmatch-workbench-chain-replay-2z.md",
    reason: "Sprint 2Z experimental full-match chain consumption validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
...
function shareReadmeDoc(): string {
  return [
    "# Sprint 2Z Share Pack",
    "",
    "This compact review pack covers experimental full-match consumption of the visual WorkbenchChain behind the opt-in route selection flag.",
    "",
    "Start with:",
    "- `00-share-manifest.txt` for copied files, bundle contents, commands, and git status.",
    "- `fullmatch-workbench-chain-replay-2z.md` for experimental chain consumption status, score signature comparison, diagnostics, and guardrails.",
    "- `validation.fullmatch-workbench-chain-replay-2z.md` for opt-in chain consumption, score mutation, scoring event mutation, and source-of-truth checks.",
