...
const TASK_NAME =
  process.env.SHARE_PACK_TASK_NAME ?? "Sprint 8T - Manual Review UX Interaction Contract Without Persistence";
const WORKBENCH_CHAIN_REPLAY_REPORT_TARGET = "coach-report-manual-review-ux-interaction-contract-without-persistence-8t.md";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    reason: "current sprint manual review UX interaction contract report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET,
    reason: "current sprint manual review UX interaction contract validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
