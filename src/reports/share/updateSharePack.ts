...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 3L - Sandbox Scoring Opportunity Model";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    target: "fullmatch-workbench-chain-replay-3l.md",
    reason: "Sprint 3L sandbox scoring opportunity model report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "validation.fullmatch-workbench-chain-replay-3l.md",
    reason: "Sprint 3L sandbox scoring opportunity model validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
