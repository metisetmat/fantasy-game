...
import {
  ...
  renderManualReviewUxInteractionContractWithoutPersistence8TDoc,
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    reason: "current sprint manual review report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET,
    reason: "current sprint manual review validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
...
const BUNDLES: readonly BundleConfig[] = [
  ...
  },
  {
    ...
    sources: [
      ...
      {
        source: "src/reports/manualReviewPreviewDecisionGateTypes8Q.ts",
        required: true,
        reason: "Sprint 8Q typed decision-gate contract over the 8P comparison, including per-card and global readability states",
      },
      {
        source: "src/reports/manualReviewPreviewDecisionGateWarnings8Q.ts",
        required: true,
        reason: "Sprint 8Q warning registry blocking persistence, official-truth promotion, score/timeline mutation, automation, and stale export metadata",
      },
      {
        source: "src/reports/manualReviewPreviewDecisionGateAudit8Q.ts",
        required: true,
        reason: "Sprint 8Q audits for gate visibility, logic, non-persistence, official-truth boundary, source-of-truth, export metadata, export budget, integration, and wording",
      },
      {
        source: "src/reports/renderManualReviewPreviewDecisionGateProduct8Q.ts",
        required: true,
        reason: "Sprint 8Q product renderer adding the preview decision gate immediately after the 8P comparison",
      },
      {
        source: "src/reports/renderManualReviewPreviewDecisionGateExport8Q.ts",
        required: true,
        reason: "Sprint 8Q compact export renderer adding the gate preview and updating export metadata away from stale 8P labels",
      },
      {
        source: "src/reports/buildManualReviewPreviewDecisionGateWithoutPersistence8Q.ts",
        required: true,
        reason: "Sprint 8Q model, report renderer, and validation renderer for the non-persistent manual review preview decision gate",
      },
      {
        source: "src/reports/manualReviewPreviewDecisionGate8Q.test.ts",
        required: true,
      ...
      {
        source: "src/reports/manualReviewUxInteractionContractTypes8T.ts",
        required: true,
        reason: "Sprint 8T typed future interaction contract, blocked future interactions, refusal states, activation requirements, and source-of-truth boundaries",
      },
      {
        source: "src/reports/manualReviewUxInteractionContractWarnings8T.ts",
        required: true,
        reason: "Sprint 8T warning registry for future-only interaction contract, disabled-state, non-persistence, metadata, wording, and source-of-truth guardrails",
      },
      {
        source: "src/reports/manualReviewUxInteractionContractAudit8T.ts",
        required: true,
        reason: "Sprint 8T audits for interaction contract visibility, zero enabled controls, non-persistence, official-truth boundary, export metadata, budget, integration, and wording",
      },
      {
        source: "src/reports/renderManualReviewUxInteractionContractProduct8T.ts",
        required: true,
        reason: "Sprint 8T product renderer adding the future-only manual review interaction contract after the 8S UX skeleton",
      },
      {
        source: "src/reports/renderManualReviewUxInteractionContractExport8T.ts",
        required: true,
        reason: "Sprint 8T compact export renderer adding the interaction contract summary and updating export metadata to 8T",
      },
      {
        source: "src/reports/buildManualReviewUxInteractionContractWithoutPersistence8T.ts",
        required: true,
        reason: "Sprint 8T model, report renderer, and validation renderer for the manual review UX interaction contract proof",
      },
      {
        source: "src/reports/manualReviewUxInteractionContract8T.test.ts",
        required: true,
        reason: "Sprint 8T test proving six blocked future interactions, six refusal states, no submit/API/persistence/official truth/selection/tactic, and current 8T export metadata",
      },
      {
        source: "src/reports/manualReviewInputFieldContractTypes8U.ts",
        required: true,
        reason: "Sprint 8U typed future input-field contract, three sections, twenty-one disabled fields, inactive validation rules, error states, refusal states, activation requirements, and source-of-truth boundaries",
      },
      {
        source: "src/reports/manualReviewInputFieldContractWarnings8U.ts",
        required: true,
        reason: "Sprint 8U warning registry for future-only field contract, disabled-state, non-persistence, metadata, wording, and source-of-truth guardrails",
      },
      {
        source: "src/reports/manualReviewInputFieldContractAudit8U.ts",
        required: true,
        reason: "Sprint 8U audits for field contract visibility, zero active fields, zero enabled controls, non-persistence, official-truth boundary, export metadata, budget, integration, and wording",
      },
      {
        source: "src/reports/renderManualReviewInputFieldContractProduct8U.ts",
        required: true,
        reason: "Sprint 8U product renderer adding the static future input-field contract after the 8T interaction contract",
      },
      {
        source: "src/reports/renderManualReviewInputFieldContractExport8U.ts",
        required: true,
        reason: "Sprint 8U compact export renderer adding the field contract summary and updating export metadata to 8U",
      },
      {
        source: "src/reports/buildManualReviewInputFieldContractWithoutPersistence8U.ts",
        required: true,
        reason: "Sprint 8U model, report renderer, and validation renderer for the manual review input field contract proof",
      },
      {
        source: "src/reports/manualReviewInputFieldContract8U.test.ts",
        required: true,
      ...
      {
        source: "src/reports/manualReviewPreviewPayloadDryRunCoachFacingErrorCopyWarnings9E.ts",
        required: true,
        reason: "Sprint 9E warning registry for coach-facing dry-run error copy and no-runtime blockers",
      },
      {
        source: "src/reports/manualReviewPreviewPayloadDryRunCoachFacingErrorCopyTypes9E.ts",
        required: true,
        reason: "Sprint 9E typed coach-facing error-copy contract and audit model",
      },
      {
        source: "src/reports/manualReviewPreviewPayloadDryRunCoachFacingErrorCopyCatalog9E.ts",
        required: true,
        reason: "Sprint 9E coach-facing copy catalog covering compatible, error, blocker, boundary, and refusal states",
      },
      {
        source: "src/reports/manualReviewPreviewPayloadDryRunCoachFacingErrorCopyCoverageAudit9E.ts",
        required: true,
        reason: "Sprint 9E coverage audit proving all dry-run error, blocker, boundary, and refusal states have coach-facing wording",
      },
      {
        source: "src/reports/manualReviewPreviewPayloadDryRunCoachFacingErrorCopyWordingAudit9E.ts",
        required: true,
        reason: "Sprint 9E wording audit blocking official-truth, payload-acceptance, selection, tactical, storage, and runtime claims",
      },
      {
        source: "src/reports/manualReviewPreviewPayloadDryRunCoachFacingErrorCopyNoRuntimeAudit9E.ts",
        required: true,
        reason: "Sprint 9E no-runtime audit preserving dry-run-only behavior without payload reads or preview activation",
      },
      {
        source: "src/reports/manualReviewPreviewPayloadDryRunCoachFacingErrorCopyExportMetadataAudit9E.ts",
        required: true,
        reason: "Sprint 9E strict export metadata audit for title, main id, current data attribute, cover badge, and historical 9D markers",
      },
      {
        source: "src/reports/manualReviewPreviewPayloadDryRunCoachFacingErrorCopyExportBudgetAudit9E.ts",
        required: true,
        reason: "Sprint 9E export budget audit proving the coach-facing copy remains inside the 900-second export limit",
      },
      {
        source: "src/reports/manualReviewPreviewPayloadDryRunCoachFacingErrorCopySourceOfTruthAudit9E.ts",
        required: true,
        reason: "Sprint 9E source-of-truth audit preserving scoring constants, batch/live separation, and MatchBonusEvent boundaries",
      },
      {
        source: "src/reports/renderManualReviewPreviewPayloadDryRunCoachFacingErrorCopyProduct9E.ts",
        required: true,
        reason: "Sprint 9E product renderer adding coach-facing dry-run error copy without activating preview or validation runtime",
      },
      {
        source: "src/reports/renderManualReviewPreviewPayloadDryRunCoachFacingErrorCopyExport9E.ts",
        required: true,
        reason: "Sprint 9E export renderer normalizing title/main id/badge/data attribute and adding compact copy evidence",
      },
      {
        source: "src/reports/buildManualReviewPreviewPayloadDryRunCoachFacingErrorCopyWithoutPreviewActivation9E.ts",
        required: true,
        reason: "Sprint 9E builder, report renderer, and validation renderer for coach-facing dry-run error copy",
      },
      {
        source: "src/reports/manualReviewPreviewPayloadDryRunCoachFacingErrorCopy9E.test.ts",
        required: true,
...
function fullMatchWorkbenchChainReplayDoc(): string {
  ...
  if (TASK_NAME.includes("Sprint 8T")) {
    return renderManualReviewUxInteractionContractWithoutPersistence8TDoc(fullMatchTraceValidationModel());
  }
...
function fullMatchWorkbenchChainReplayValidationDoc(): string {
  ...
  if (TASK_NAME.includes("Sprint 8T")) {
    return renderManualReviewUxInteractionContractWithoutPersistence8TValidation(fullMatchTraceValidationModel());
  }
  if (TASK_NAME.includes("Sprint 8S")) {
...
function shareReadmeDoc(): string {
  ...
  if (TASK_NAME.includes("Sprint 8U")) {
    return [
      ...
      "",
      "Current sprint: Sprint 8U - Manual Review Input Field Contract Without Persistence",
      "",
      "Upload every file in this `reports/share` directory for review. This minimal pack keeps the 8T interaction contract embedded in product/export reports, then replaces the standalone 8T docs with the 8U input-field contract docs.",
      "",
      "## What To Review First",
      "1. coach-report.export.html",
      "2. coach-report.product.html",
      "3. validation.coach-report-manual-review-input-field-contract-without-persistence-8u.md",
      "4. coach-report-manual-review-input-field-contract-without-persistence-8u.md",
      "5. validation.share-pack.md",
      "",
      "## Sprint 8U Focus",
      "- The 8U contract defines future manual-review input fields without activating real input.",
      "- Three review sections and twenty-one fields are visible as static matrix rows, all disabled, inactive, and read-only.",
      "- Twelve future validation rules and eleven future error states are documented but inactive.",
      "- Six refusal states and fourteen activation requirements explain why real input, payload creation, preview generation, storage, official truth, selection, and tactics are not active yet.",
      "- Export metadata now mentions 8U and the compact export main id is cleaned to compressed-export-8u.",
      "",
      "## Guardrails",
      "- Scoring values unchanged.",
      "- PENALTY_SHOT inactive.",
      ...
      "- Manual input field contract creates no input, submit, API, backend, storage, memory, payload, preview, official truth, selection, or tactical instruction.",
      "- Share pack remains at or below 20 files.",
      "",
      "## Recommendation",
      "- KEEP_MANUAL_REVIEW_INPUT_FIELD_CONTRACT",
      "- PREPARE_MANUAL_REVIEW_FIELD_UX_VISUAL_READINESS",
      "",
    ].join("\n");
  }
  if (TASK_NAME.includes("Sprint 8T")) {
