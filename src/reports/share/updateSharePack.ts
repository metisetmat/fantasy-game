...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 6O - Earned Danger Reintroduction & Gate Tuning";
const WORKBENCH_CHAIN_REPLAY_REPORT_TARGET = "fullmatch-earned-danger-gate-tuning-6o.md";
const WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET = "validation.fullmatch-earned-danger-gate-tuning-6o.md";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    reason: "current sprint full-match earned danger gate tuning report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET,
    reason: "current sprint full-match earned danger gate tuning validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
