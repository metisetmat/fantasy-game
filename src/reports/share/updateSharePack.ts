...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 2T - Attribute-Driven Route Ranking";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    target: "attribute-driven-route-ranking.md",
    reason: "Sprint 2T attribute-driven route ranking report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "validation.attribute-driven-route-ranking.md",
    reason: "Sprint 2T attribute-driven route ranking validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        required: true,
        reason: "Sprint 2T route attribute influence contract",
      },
      {
        source: "src/simulation/routeRanking/routeAttributeInfluence.ts",
        required: true,
        reason: "Sprint 2T bounded route attribute influence helpers",
      },
      {
        source: "src/simulation/routeRanking/applySpatialAttributeInfluenceToCandidates.ts",
        required: true,
        reason: "Sprint 2T candidate attribute adjustment adapter",
      },
      {
        source: "src/simulation/diagnostics/fullMatchGroundingDiagnostics.ts",
        required: true,
        reason: "Sprint 2T warning-only partial full-match grounding diagnostics with route attribute influence",
      },
      {
      ...
      },
      {
        ...
        required: true,
        reason: "Sprint 2T executable workbench replay seed tests with route attribute influence",
      },
      {
        source: "src/simulation/routeRanking/routeAttributeInfluence.test.ts",
        required: true,
        reason: "Sprint 2T executable route attribute influence tests",
      },
      {
        source: "src/simulation/routeRanking/applySpatialAttributeInfluenceToCandidates.test.ts",
        required: true,
        reason: "Sprint 2T executable candidate attribute adjustment tests",
      },
      {
...
function attributeDrivenRouteRankingDoc(): string {
  return [
...
function attributeDrivenRouteRankingValidationDoc(): string {
  return [
...
function shareReadmeDoc(): string {
  return [
    "# Sprint 2T Share Pack",
    "",
    "This compact review pack covers bounded attribute-driven route ranking influence and the remaining PARTIAL selection gap.",
    "",
    "Start with:",
    "- `00-share-manifest.txt` for copied files, bundle contents, commands, and git status.",
    "- `attribute-driven-route-ranking.md` for the route attribute influence layer, replay seed evidence, partial status, and next steps.",
    "- `validation.attribute-driven-route-ranking.md` for bounded modifiers, adjusted candidate scores, replay seed, and guardrail checks.",
    "- `sequence-1-action-1.html` for the source workbench artifact and visual truth.",
    "- `bundle__simulation.md` for routeRanking files/tests, spatial context adapters, replay seed, grounding diagnostics, mini/full-match wiring, and evidence.",
...
function writeGeneratedShareDocs(shareDirectory: string): readonly CopiedStandaloneFile[] {
  const generatedDocs = [
    {
      target: "attribute-driven-route-ranking.md",
      content: attributeDrivenRouteRankingDoc(),
    },
    {
      target: "validation.attribute-driven-route-ranking.md",
      content: attributeDrivenRouteRankingValidationDoc(),
    },
    {
      target: "README.md",
