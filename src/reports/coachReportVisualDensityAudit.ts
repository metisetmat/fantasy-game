...
export function auditCoachReportVisualDensity(input: {
  ...
  const excessiveVisualDensity = visualDensityDelta > 5 || visualDensityScoreAfter > 92 || visualCardCount > 3 || duplicatedVisualContentCount > 0;
  ...
  const visualDensityWarningCodes: CoachReportPhaseVisualsTacticalMapCardsWarningCode[] = [
    ...
    ...(visualDensityScoreAfter > 92 ? ["VISUAL_CARDS_TOO_DENSE" as const] : []),
