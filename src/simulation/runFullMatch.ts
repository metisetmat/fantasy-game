...
import { buildSelectionPreviewProfileView } from "../reports/buildSelectionPreviewProfileView";
import {
...
import {
  coachReportRealMatchHistoryEvidenceFact,
  coachReportRealMatchHistoryLimitations,
} from "../reports/coachReportRealMatchHistoryIntegration";
import {
...
export function runFullMatch(input: MatchInput, options?: FullMatchOptions): MatchReport {
  ...
  const selectionPreviewProfileViewModel = buildSelectionPreviewProfileView({
  ...
  const selectionPreviewProfileViewModelFact = selectionPreviewProfileViewEvidenceFact({
    report,
    matchInput: input,
  ...
  const coachReportRealMatchHistoryIntegrationModelFact = coachReportRealMatchHistoryIntegrationModel === null
    ? null
    : coachReportRealMatchHistoryEvidenceFact({
        report,
        matchInput: input,
