...
export function validateSourceOfTruthGuards3S(): readonly string[] {
...
if (require.main === module) {
  const checks = validateSourceOfTruthGuards3S();

  console.log("sourceOfTruthGuards.3s tests passed.");
