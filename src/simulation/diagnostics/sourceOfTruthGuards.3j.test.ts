...
export function validateSourceOfTruthGuards3J(): readonly string[] {
...
if (require.main === module) {
  const checks = validateSourceOfTruthGuards3J();

  console.log("sourceOfTruthGuards.3j tests passed.");
