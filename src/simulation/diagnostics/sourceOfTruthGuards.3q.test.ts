...
export function validateSourceOfTruthGuards3Q(): readonly string[] {
...
if (require.main === module) {
  const checks = validateSourceOfTruthGuards3Q();

  console.log("sourceOfTruthGuards.3q tests passed.");
