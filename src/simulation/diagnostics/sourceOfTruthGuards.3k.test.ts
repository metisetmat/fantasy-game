...
export function validateSourceOfTruthGuards3K(): readonly string[] {
...
if (require.main === module) {
  const checks = validateSourceOfTruthGuards3K();

  console.log("sourceOfTruthGuards.3k tests passed.");
