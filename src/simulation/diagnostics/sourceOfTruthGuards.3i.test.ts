...
export function validateSourceOfTruthGuards3I(): readonly string[] {
...
if (require.main === module) {
  const checks = validateSourceOfTruthGuards3I();

  console.log("sourceOfTruthGuards.3i tests passed.");
