...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| full-match-segment-1-2 | 2-2 | scoring_sequence | control | 0 - 0 -> 3 - 0 | rc-second-ball-chaser/space_hunter | Z3-C | score_created | contract-fixture-001-segment-1-score-1 | high | Lecture limitee aux acteurs explicitement presents dans la timeline officielle. |
| full-match-segment-1-3 | 3-3 | recovery_sequence | blitz | 3 - 0 -> 3 - 0 | rc-creative-support/playmaker | Z3-C | fatigue_visible | contract-fixture-001-segment-1-sequence-3 | medium | Lecture limitee aux acteurs explicitement presents dans la timeline officielle. |
| full-match-segment-2-5 | 15-15 | scoring_sequence | control | 3 - 0 -> 6 - 0 | rc-low-endurance-creator/playmaker | Z3-C | score_created | contract-fixture-001-segment-2-score-1 | high | Lecture limitee aux acteurs explicitement presents dans la timeline officielle. |
...
| full-match-segment-3-5 | 25-25 | scoring_sequence | control | 6 - 7 -> 9 - 7 | rc-mobile-connector/hook_link | Z3-C | score_created | contract-fixture-001-segment-3-score-1 | high | Lecture limitee aux acteurs explicitement presents dans la timeline officielle. |
| full-match-segment-4-3 | 33-33 | scoring_sequence | control | 9 - 7 -> 12 - 7 | rc-hybrid-role/left_piston | Z3-C | score_created | contract-fixture-001-segment-4-score-1 | high | Lecture limitee aux acteurs explicitement presents dans la timeline officielle. |

## Actor Contributions
| Sequence | Event | Player | Role | Function | Action role | Zone | Effect | Limit |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| full-match-segment-1-2 | contract-fixture-001-segment-1-score-1 | rc-second-ball-chaser | space_hunter | space_attacker | finishes | Z3-C | score_created | Contribution reliee a un event officiel team-level; le joueur illustre la fonction de role, pas une attribution exclusive. |
| full-match-segment-1-3 | contract-fixture-001-segment-1-sequence-3 | rc-creative-support | playmaker | tempo_setter | pressures | Z3-C | fatigue_visible | Contribution reliee a un event officiel team-level; le joueur illustre la fonction de role, pas une attribution exclusive. |
| full-match-segment-2-5 | contract-fixture-001-segment-2-score-1 | rc-low-endurance-creator | playmaker | tempo_setter | finishes | Z3-C | score_created | Contribution reliee a un event officiel team-level; le joueur illustre la fonction de role, pas une attribution exclusive. |
...
| full-match-segment-3-5 | contract-fixture-001-segment-3-score-1 | rc-mobile-connector | hook_link | central_reconnector | finishes | Z3-C | score_created | Contribution reliee a un event officiel team-level; le joueur illustre la fonction de role, pas une attribution exclusive. |
| full-match-segment-4-3 | contract-fixture-001-segment-4-score-1 | rc-hybrid-role | left_piston | support_runner | finishes | Z3-C | score_created | Contribution reliee a un event officiel team-level; le joueur illustre la fonction de role, pas une attribution exclusive. |

## Role Function Chains
| Sequence | Pattern | Players | Roles | Functions | Effect | Evidence |
| --- | --- | --- | --- | --- | --- | --- |
| full-match-segment-1-2 | score_after_progression | rc-second-ball-chaser | space_hunter | space_attacker | score_created | contract-fixture-001-segment-1-score-1 |
| full-match-segment-1-3 | recover_connect_progress | rc-creative-support | playmaker | tempo_setter | fatigue_visible | contract-fixture-001-segment-1-sequence-3 |
| full-match-segment-2-5 | score_after_progression | rc-low-endurance-creator | playmaker | tempo_setter | score_created | contract-fixture-001-segment-2-score-1 |
...
| full-match-segment-3-5 | score_after_progression | rc-mobile-connector | hook_link | central_reconnector | score_created | contract-fixture-001-segment-3-score-1 |
| full-match-segment-4-3 | score_after_progression | rc-hybrid-role | left_piston | support_runner | score_created | contract-fixture-001-segment-4-score-1 |
...
Score officiel 12 - 7; Sequence de score officielle: rc-second-ball-chaser (space_hunter) pese sur score_created en Z3-C, avec preuve officielle contract-fixture-001-segment-1-score-1.

## Coach-Facing Sequence Causality Excerpt
rc-second-ball-chaser (space_hunter) pese sur score_created via Z3-C; source contract-fixture-001-segment-1-score-1. rc-creative-support (playmaker) pese sur fatigue_visible via Z3-C; source contract-fixture-001-segment-1-sequence-3. rc-low-endurance-creator (playmaker) pese sur score_created via Z3-C; source contract-fixture-001-segment-2-score-1.
