...
| invalid-2 | rejected | INVALID_ENTRY_COUNT, MISSING_LINKED_SECTION |
| invalid-3 | rejected | DUPLICATE_LINKED_SECTION, MISSING_LINKED_SECTION |
| invalid-4 | rejected | INVALID_SOURCE_MATCH_ID |
| invalid-5 | rejected | INVALID_MANUAL_COUNT |
| invalid-6 | rejected | MISSING_LINKED_SECTION, UNKNOWN_LINKED_SECTION |
| invalid-7 | rejected | AUTO_CLASSIFIED_TRUE |
| invalid-8 | rejected | OFFICIAL_TRUTH_TRUE |
| invalid-9 | rejected | INVALID_PERSISTENCE_INTENT |
| invalid-10 | rejected | SCORE_MUTATION_REQUESTED |
| invalid-11 | rejected | TIMELINE_MUTATION_REQUESTED |
| invalid-12 | rejected | SCORING_EVENT_CREATION_REQUESTED |
| invalid-13 | rejected | SEASON_MEMORY_REQUESTED |
| invalid-14 | rejected | TEAM_STYLE_MEMORY_REQUESTED |
| invalid-15 | rejected | CAN_DRIVE_SELECTION_TRUE |
| invalid-16 | rejected | CAN_DRIVE_TACTICAL_INSTRUCTION_TRUE |
| invalid-17 | rejected | MISSING_BOUNDARY_ACKNOWLEDGEMENT, MISSING_BOUNDARY_ACKNOWLEDGEMENT, MISSING_BOUNDARY_ACKNOWLEDGEMENT, MISSING_BOUNDARY_ACKNOWLEDGEMENT, MISSING_BOUNDARY_ACKNOWLEDGEMENT, MISSING_BOUNDARY_ACKNOWLEDGEMENT, MISSING_BOUNDARY_ACKNOWLEDGEMENT |
