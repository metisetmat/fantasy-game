...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 3H - Isolated MiniMatch Override Experiment";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    target: "fullmatch-workbench-chain-replay-3h.md",
    reason: "Sprint 3H isolated mini-match override experiment report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "validation.fullmatch-workbench-chain-replay-3h.md",
    reason: "Sprint 3H isolated mini-match override experiment validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
...
function shareReadmeDoc(): string {
  return [
    "# Sprint 3H Share Pack",
    "",
    "This compact review pack covers isolated mini-match override application from the prepared live selection override guard behind the opt-in route selection flag.",
    "",
    "Start with:",
    "- `00-share-manifest.txt` for copied files, bundle contents, commands, and git status.",
    "- `fullmatch-workbench-chain-replay-3h.md` for isolated override status, baseline-versus-override comparison, override candidate identity, rejected candidates, score signature comparison, diagnostics, and guardrails.",
    "- `validation.fullmatch-workbench-chain-replay-3h.md` for opt-in isolated mini-match override, normal score mutation, normal scoring event mutation, production scoring-event creation, route-success mutation, production-resolution guardrails, global-economy guardrails, and source-of-truth checks.",
