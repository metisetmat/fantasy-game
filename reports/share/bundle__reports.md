...
Generated for Sprint 4N - Coach Report Export / Product View. Source files are bundled by domain for compact ChatGPT review.
...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 4N - Coach Report Export / Product View";
const WORKBENCH_CHAIN_REPLAY_REPORT_TARGET = "fullmatch-workbench-chain-replay-4n.md";
const WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET = "validation.fullmatch-workbench-chain-replay-4n.md";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    reason: "Sprint 4N Coach Product Report View summary report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET,
    reason: "Sprint 4N Coach Product Report View validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        required: true,
        reason: "Sprint 4N product-facing HTML renderer",
      },
      {
...
export function productMainVisibleHtml(html: string): string {
  const appendicesStart = html.indexOf("<section id=\"appendices\">");
