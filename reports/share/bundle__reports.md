...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 3N - Sandbox Scoring Event Resolution";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    target: "fullmatch-workbench-chain-replay-3n.md",
    reason: "Sprint 3N sandbox scoring event resolution report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "validation.fullmatch-workbench-chain-replay-3n.md",
    reason: "Sprint 3N sandbox scoring event resolution validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
