...
Generated for Sprint 4Y - Multi-Match History View & Trend Drilldown. Source files are bundled by domain for compact ChatGPT review.
...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 4Y - Multi-Match History View & Trend Drilldown";
const WORKBENCH_CHAIN_REPLAY_REPORT_TARGET = "fullmatch-workbench-chain-replay-4y.md";
const WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET = "validation.fullmatch-workbench-chain-replay-4y.md";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    reason: "Sprint 4Y Multi-Match History View summary report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET,
    reason: "Sprint 4Y Multi-Match History View validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
