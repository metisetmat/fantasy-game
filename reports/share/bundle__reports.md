...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 3K - Controlled Route Resolution Sandbox";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    target: "fullmatch-workbench-chain-replay-3k.md",
    reason: "Sprint 3K controlled route resolution sandbox report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "validation.fullmatch-workbench-chain-replay-3k.md",
    reason: "Sprint 3K controlled route resolution sandbox validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
