...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 4A - Multi-Scenario Coach Test Plan";
const WORKBENCH_CHAIN_REPLAY_REPORT_TARGET = "fullmatch-workbench-chain-replay-4a.md";
const WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET = "validation.fullmatch-workbench-chain-replay-4a.md";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    reason: "Sprint 4A multi-scenario coach test plan report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET,
    reason: "Sprint 4A multi-scenario coach test plan validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
...
function fullMatchWorkbenchChainReplayDoc(): string {
  if (TASK_NAME.includes("Sprint 4A")) {
    return [
