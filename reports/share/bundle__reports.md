...
import {
  renderFullMatchTraceValidation4GReport,
...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 4G - Profile Signal Calibration & Encoding Fix";
const WORKBENCH_CHAIN_REPLAY_REPORT_TARGET = "fullmatch-workbench-chain-replay-4g.md";
const WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET = "validation.fullmatch-workbench-chain-replay-4g.md";
const FULL_MATCH_TRACE_VALIDATION_TARGET = "fullmatch-trace-validation-4g.md";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    reason: "Sprint 4G profile signal calibration summary report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET,
    reason: "Sprint 4G profile signal calibration and encoding checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: FULL_MATCH_TRACE_VALIDATION_TARGET,
    reason: "Sprint 4G detailed full-match trace validation and profile signal report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
...
function writeGeneratedShareDocs(shareDirectory: string): readonly CopiedStandaloneFile[] {
  const generatedDocs = [
    ...
    {
      target: FULL_MATCH_TRACE_VALIDATION_TARGET,
      content: renderFullMatchTraceValidation4GReport(fullMatchTraceValidationModel()),
    },
    {
      target: "README.md",
