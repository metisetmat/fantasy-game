...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 3M - Sandbox Scoring Event Candidate";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    target: "fullmatch-workbench-chain-replay-3m.md",
    reason: "Sprint 3M sandbox scoring event candidate report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "validation.fullmatch-workbench-chain-replay-3m.md",
    reason: "Sprint 3M sandbox scoring event candidate validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
