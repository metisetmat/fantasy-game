...
import {
  renderFullMatchTraceValidationReport,
...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 4F - Full Match Trace Validation";
const WORKBENCH_CHAIN_REPLAY_REPORT_TARGET = "fullmatch-workbench-chain-replay-4f.md";
const WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET = "validation.fullmatch-workbench-chain-replay-4f.md";
const FULL_MATCH_TRACE_VALIDATION_TARGET = "fullmatch-trace-validation-4f.md";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    reason: "Sprint 4F full-match trace validation summary report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET,
    reason: "Sprint 4F full-match trace validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: FULL_MATCH_TRACE_VALIDATION_TARGET,
    reason: "Sprint 4F detailed full-match trace validation profile report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
...
function writeGeneratedShareDocs(shareDirectory: string): readonly CopiedStandaloneFile[] {
  const generatedDocs = [
    ...
    {
      target: FULL_MATCH_TRACE_VALIDATION_TARGET,
      content: renderFullMatchTraceValidationReport(fullMatchTraceValidationModel()),
    },
    {
      target: "README.md",
