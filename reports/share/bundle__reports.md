...
Generated for Sprint 4P - Player Matchup View. Source files are bundled by domain for compact ChatGPT review.
...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 4P - Player Matchup View";
const WORKBENCH_CHAIN_REPLAY_REPORT_TARGET = "fullmatch-workbench-chain-replay-4p.md";
const WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET = "validation.fullmatch-workbench-chain-replay-4p.md";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    reason: "Sprint 4P Player Matchup View summary report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET,
    reason: "Sprint 4P Player Matchup View validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
...
function fullMatchWorkbenchChainReplayDoc(): string {
  if (TASK_NAME.includes("Sprint 4P")) {
    return renderFullMatchWorkbenchChainReplay4PDoc(fullMatchTraceValidationModel());
  }
...
function fullMatchWorkbenchChainReplayValidationDoc(): string {
  if (TASK_NAME.includes("Sprint 4P")) {
    return renderFullMatchWorkbenchChainReplay4PValidation(fullMatchTraceValidationModel());
  }
