...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 4V - Phase Visuals & Tactical Pitch Panels";
const WORKBENCH_CHAIN_REPLAY_REPORT_TARGET = "fullmatch-workbench-chain-replay-4v.md";
const WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET = "validation.fullmatch-workbench-chain-replay-4v.md";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    reason: "Sprint 4V Phase Visuals summary report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET,
    reason: "Sprint 4V Phase Visuals validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        required: true,
        reason: "Sprint 4V tactical pitch panel renderer for coach-facing phase visuals",
      },
      {
