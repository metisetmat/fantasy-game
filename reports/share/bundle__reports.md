...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 3C - Experimental Chain Context to Shadow Route Selection";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    target: "fullmatch-workbench-chain-replay-3c.md",
    reason: "Sprint 3C experimental chain context to shadow route selection report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "validation.fullmatch-workbench-chain-replay-3c.md",
    reason: "Sprint 3C shadow route selection validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
