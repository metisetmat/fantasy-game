...
Generated for Sprint 4L - Selection Preview Clarity & Coach-Ready Copy. Source files are bundled by domain for compact ChatGPT review.
...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 4L - Selection Preview Clarity & Coach-Ready Copy";
const WORKBENCH_CHAIN_REPLAY_REPORT_TARGET = "fullmatch-workbench-chain-replay-4l.md";
const WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET = "validation.fullmatch-workbench-chain-replay-4l.md";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    reason: "Sprint 4L Selection Preview coach-ready copy summary report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: WORKBENCH_CHAIN_REPLAY_VALIDATION_TARGET,
    reason: "Sprint 4L Selection Preview coach-ready copy validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
