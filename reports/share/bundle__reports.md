...
const TASK_NAME = process.env.SHARE_PACK_TASK_NAME ?? "Sprint 3A - Experimental Chain Influence on Segment Context";
...
const GENERATED_SHARE_DOCS: readonly CopiedStandaloneFile[] = [
  {
    ...
    target: "fullmatch-workbench-chain-replay-3a.md",
    reason: "Sprint 3A experimental chain influence on segment context report",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "validation.fullmatch-workbench-chain-replay-3a.md",
    reason: "Sprint 3A experimental chain influence on segment context validation checklist",
  },
  {
    source: "generated by src/reports/share/updateSharePack.ts",
    target: "README.md",
...
function shareReadmeDoc(): string {
  return [
    "# Sprint 3A Share Pack",
    "",
    "This compact review pack covers experimental WorkbenchChain influence on segment-1 context behind the opt-in route selection flag.",
    "",
    "Start with:",
    "- `00-share-manifest.txt` for copied files, bundle contents, commands, and git status.",
    "- `fullmatch-workbench-chain-replay-3a.md` for experimental segment context status, score signature comparison, diagnostics, and guardrails.",
    "- `validation.fullmatch-workbench-chain-replay-3a.md` for opt-in segment context influence, score mutation, scoring event mutation, and source-of-truth checks.",
    "- `sequence-1-action-1.html`, `sequence-1-action-2.html`, and `sequence-1-action-3.html` for visual workbench truth.",
    "- `bundle__simulation.md` for multi-action WorkbenchChain files/tests, segment context influence, full-match route selection flag files/tests, mini-match route selection files/tests, replay seed, grounding diagnostics, and evidence.",
